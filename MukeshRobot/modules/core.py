...
from MukeshRobot import TEMP_DOWNLOAD_DIRECTORY as path
from MukeshRobot import TEMP_DOWNLOAD_DIRECTORY
from datetime import datetime

water = "./MukeshRobot/resources/fallen.jpg"
client = tbot
...
async def Prof(event):
    ...
    the_plugin_file = "./MukeshRobot/modules/{}.py".format(input_str)
...
from MukeshRobot.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "MukeshRobot/modules/",  # pylint:disable=E0602
                )
            )
...
from MukeshRobot import telethn as tbot, OWNER_ID, DEV_USERS
from MukeshRobot.events import register
import os
import asyncio
import os
